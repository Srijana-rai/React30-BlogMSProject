...
<nav class="bg-neutral-primary w-full z-20 top-0 start-0 border-b border-defaul ">
  ...
  <div class="flex items-center md:order-2">
    ...
    <div class="relative hidden md:block">
      ...
      <input type="text" id="input-group-1" class="block w-full ps-9 pe-3 py-2\.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand px-2.5 py-2.5 shadow-xs placeholder:text-body" placeholder="Search"/>
    </div>
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
        <li>
          <a href="#" class="block py-2 px-3 text-heading bg-brand rounded md:bg-transparent md:text-fg-brand md:p-0" aria-current="page">Home</a>
        </li>
        <li>
