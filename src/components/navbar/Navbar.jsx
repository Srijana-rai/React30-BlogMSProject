...
<nav className="bg-neutral-primary w-full z-20 top-0 start-0 border-b border-defaul ">
  ...
  <div className="flex items-center md:order-2">
    ...
    <div className="relative hidden md:block">
      ...
      <input type="text" id="input-group-1" className="block w-full ps-9 pe-3 py-2\.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand px-2.5 py-2.5 shadow-xs placeholder:text-body" placeholder="Search"/>
    </div>
